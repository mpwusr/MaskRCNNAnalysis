# source: https://learnopencv.com/mask-r-cnn-instance-segmentation-with-pytorch/

# you might need to pip install opencv-python to install cv2
...
img = Image.open('./my_images/example.jpg')
plt.imshow(img)
plt.show()
...
# Let's plot the mask for the `person` class -- the 0th mask belongs to `person`
# note that there are multiple people in the image--masks[0] identifies the first one
plt.imshow(masks[0], cmap='gray')
plt.show()


# Color the `person` mask using the `random_colour_masks` function
